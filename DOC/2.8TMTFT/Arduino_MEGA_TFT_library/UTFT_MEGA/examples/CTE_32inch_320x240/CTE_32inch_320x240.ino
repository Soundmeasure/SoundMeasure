...
UTFT myGLCD(CTE32,38,39,40,41);   // Remember to change the model parameter to suit your display module!
...
void loop()
{
  ...
  myGLCD.Put_Text("12345789",10,165,BVS_74);
...
unsigned int k=7,location=1;
while(k>0)
{ 
  myGLCD.clrScr(); 
  for (unsigned temp1 =0; temp1<5; temp1++)
  {
    for (unsigned temp2 =0; temp2<7; temp2++)
    {
